                ...
                <ul>
                  <li className="flex">
                    ...
                    >
                      ...
                      <span className="ml-4 hover:text-yellow-400 hover:text-yellow-400">Follow on Instagram</span>
                    </a>
                  </li>
                  <li className="mt-4 flex">
                    ...
                    >
                      ...
                      <span className="ml-4 hover:text-yellow-400">Follow on Twitter</span>
                    </a>
                  </li>
                  <li className="mt-4 flex">
                    <a
                    ...
                    >
                      ...
                      <span className="ml-4 hover:text-yellow-400">Follow on LinkedIn</span>
                    </a>
                  </li>
                  <li className="mt-4 flex">
                    <a
                    ...
                    >
                      ...
                      <span className="ml-4 hover:text-yellow-400">Follow on GitHub</span>
                    </a>
                  </li>
                  <li className="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex">
                    ...
                    >
                      ...
                      <span className="ml-4 hover:text-yellow-400">austinmorrowdev@gmail.com</span>
                    </a>
                  </li>
                </ul>
              </div>
